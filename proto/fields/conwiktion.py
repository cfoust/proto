"""Conwiktion provides a field type, WiktionaryField, that parses the English Wiktionary for results."""
...
def get_soup_from_url(url_in):
    return soup(get_data_from_url(url_in), "html5lib")
...
class WiktionaryField(CacheableFieldType):
    ...
    def __init__(self,db,languageName,languageCode):
        """db: database object for peewee
           languageName: English name of language. (e.g 'Russian')
