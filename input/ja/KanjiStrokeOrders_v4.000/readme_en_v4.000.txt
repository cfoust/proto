...
I have received field reports that KSOF does not work with Microsoft Word,
at least on Mac. As far as I can tell, this is because that wordprocessing
package locks iteself down to a limited number of fonts rather than any
kind of problem with KSOF. Further field feedback on this welcome.
...
included with this archive in the file copyright.txt. This license is very
permissive. In particular, the license permits:
...
these into a font using Fontforge. I use Fontforge for ongoing development.
...
investigate. My primary reference is http://kakijun.jp/.
...
2016/07/04  4.000 Corrected errors reported by users and added some characters.
                  ...
                  Non-jōyō kanji that have changed:
                    ...
                    U+5A41 婁 Corrected stroke order
                    ...
                    U+8836 蠶 Adjusted position of numeral 6
